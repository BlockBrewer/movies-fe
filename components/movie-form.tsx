        ...
        >
          <div>
            <label htmlFor="image-upload" className="block cursor-pointer">
              <div className="ds-dropzone relative mx-auto max-w-[var(--ds-form-preview-width)] overflow-hidden rounded-2xl border-2 border-dashed">
                {preview ? (
                  <>
                    <img
                      src={preview}
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-4 sm:gap-4">
              <Button asChild variant="outline" size="form" className="flex-1">
                <Link href={cancelHref}>{t("fields.cancel")}</Link>
              </Button>
